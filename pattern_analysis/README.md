...
- [Single-pattern similarity search](https://jeong0449.github.io/adx/reports/search_SNG_0035_report.html) — compares one external ADT pattern against the indexed corpus.

- [Song-level deduplication](https://jeong0449.github.io/adx/reports/song_pattern_dedup.html) — identifies redundant variants within a set of song-derived patterns and distinguishes medoids from selected canonical patterns.

- [Song-level corpus comparison]((https://jeong0449.github.io/adx/reports/SNG_corpus_comparison) — compares a set of song-derived patterns against the existing corpus, TRCs, and CPFs.
