...
Example HTML reports generated by the ADX analysis tools are available online:



- [Single-pattern similarity search](https://jeong0449.github.io/Ardule/pattern_analysis/reports/search_SNG_0035_report.html) — compares one external ADT pattern against the indexed corpus.

- [Song-level deduplication](https://jeong0449.github.io/Ardule/pattern_analysis/reports/song_pattern_dedup.html) — identifies redundant variants within a set of song-derived patterns and distinguishes medoids from selected canonical patterns.

- [Song-level corpus comparison](https://jeong0449.github.io/Ardule/pattern_analysis/reports/SNG_corpus_comparison) — compares a set of song-derived patterns against the existing corpus, TRCs, and CPFs.

These reports provide native pattern visualization and make the analysis results easier to inspect without running the command-line tools locally.
