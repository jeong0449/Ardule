...
<title>ADX Drum Player 260819a</title><style>
...
<footer>Read-only browser · play_server.py 260819a. ADP is preferred when same-basename ADT and ADP both exist. Same-basename ORN is applied automatically.</footer>
</section></main><script>
(()=>{
