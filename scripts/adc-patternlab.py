...
SCRIPT_NAME="adc-patternlab.py"; VERSION="260812b"; VERSION_TEXT=f"{SCRIPT_NAME} {VERSION}"
...
<label>Compare Mode <select class="compare-mode-select"{dis}><option value="raw">RAW only</option><option value="quantized" selected>RAW → Quantized</option></select></label>
</div>
