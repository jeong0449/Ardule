...
**Curious?**
Download the self-contained [**Ardule Drum Player HTML file**](./ardule-drum-player.html) (~24.3 MB) and open it in your web browser. No installation is required. The player includes 44 embedded drum patterns and six drum kits, so you can start exploring immediately. It also runs on mobile devices, although the current interface is primarily designed for desktop screens.
